...
import (
	...
	casts "github.com/castai/terraform-provider-castai/provider" // Import the upstream provider

	"github.com/skating-cow/pulumi-casts/provider/pkg/version"
)
...
const (
	...
	mainPkg = "casts"
	// modules:
	mainMod = "index" // the casts module
)

//go:embed cmd/pulumi-resource-casts/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-casts/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-casts/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "casts", casts.Provider(),
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(casts.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing casts cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"casts", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/skating-cow/pulumi-casts",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/skating-cow/pulumi-casts/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("casts_", mainMod,
